...
package com.rust.sip.GB28181.sip.address;


import com.rust.sip.GB28181.sip.provider.SipParser;

/**
 * Class <i>NameAddress</i> is used to rapresent any valid SIP Name Address. It
 * contains a SIP URI and optionally a display name. <BR>
 * A SIP Name Address is a string of the form of: <BR>
 * <BLOCKQUOTE>
 * 
 * <PRE>
